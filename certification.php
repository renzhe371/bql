...
class thisPage extends MyWeb {
	...
	function IMDEX($form){
		...
		$sql="select certification from ".$this->table_name;
		$certification_content=$dbclass->GetOne($sql);
		$smarty->assign("certification_content",$certification_content);
		...
		$this->template_name="certification.tpl";
