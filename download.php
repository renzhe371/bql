...
class thisPage extends MyWeb {
	...
	function IMDEX($form){
		...
		$sql="select download from ".$this->table_name;
		$download_content=$dbclass->GetOne($sql);
		$smarty->assign("download_content",$download_content);
		...
		$this->template_name="download.tpl";
