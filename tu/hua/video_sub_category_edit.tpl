...
function subList()
{
	...
	if(obj)
	{
		obj.category_id.value=obj.parent_id.value
		mySubmit('LISTADDSUB');
	}
}
</script>
...
<input type="hidden" id="category_id" name="category_id" value="<{$edit.category_id}>" />
    <div id="conts">
      <h2><{$edit.parent_id|getVideoCategory}>:子类<{if $edit.add_flg eq '1'}>添加<{else}>编辑<{/if}></h2>
      <div class="conts_content">
        ...
        <ul>
            ...
            <li>
              ...
              <input class="small-input" type="text" id="order_num" name="order_num" maxlength="<{$table.category_name_en.maxlength}>" value="<{$edit.order_num|default:'0'}>" size="5" style="ime-mode: disabled;">
            ...
            <li>
              ...
              <input class="button" type="button" value="返回" onclick="subList();" />
            </li>
         </ul>
        </div>
      </div>
