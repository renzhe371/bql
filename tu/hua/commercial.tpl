...
<div id="main_body">
<form id="myform" name="myform" action="commercial.php" method="POST">
<input type="hidden" id="mode" name="mode" value="">
<input type="hidden" id="add_flg" name="add_flg" value="<{$edit.add_flg}>">
    <div id="conts">
      <h2><{$table.commercial.text}></h2>
      <div class="conts_content">
        ...
        <ul>
            ...
            <{/if}>
            <li>
              <textarea class="ckeditor" id="commercial" name="commercial"><{$edit.commercial}></textarea>
              <{if $error.commercial ne ''}><div class="error"><{$error.commercial}></div><{/if}>
            </li>
            <li>
