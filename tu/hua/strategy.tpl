...
<div id="main_body">
<form id="myform" name="myform" action="strategy.php" method="POST">
<input type="hidden" id="mode" name="mode" value="">
<input type="hidden" id="add_flg" name="add_flg" value="<{$edit.add_flg}>">
    <div id="conts">
      <h2><{$table.strategy.text}></h2>
      <div class="conts_content">
        ...
        <ul>
            ...
            <{/if}>
            <li>
              <textarea class="ckeditor" id="strategy" name="strategy"><{$edit.strategy}></textarea>
              <{if $error.strategy ne ''}><div class="error"><{$error.strategy}></div><{/if}>
            </li>
            <li>
