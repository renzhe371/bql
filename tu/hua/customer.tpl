...
<div id="main_body">
<form id="myform" name="myform" action="customer.php" method="POST">
<input type="hidden" id="mode" name="mode" value="">
<input type="hidden" id="add_flg" name="add_flg" value="<{$edit.add_flg}>">
    <div id="conts">
      <h2><{$table.customer.text}></h2>
      <div class="conts_content">
        ...
        <ul>
            ...
            <{/if}>
            <li>
              <textarea class="ckeditor" id="customer" name="customer"><{$edit.customer}></textarea>
              <{if $error.customer ne ''}><div class="error"><{$error.customer}></div><{/if}>
            </li>
            <li>
