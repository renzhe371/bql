...
<div id="main_body">
<form id="myform" name="myform" action="manager.php" method="POST">
<input type="hidden" id="mode" name="mode" value="">
<input type="hidden" id="add_flg" name="add_flg" value="<{$edit.add_flg}>">
    <div id="conts">
      <h2><{$table.manager.text}></h2>
      <div class="conts_content">
        ...
        <ul>
            ...
            <{/if}>
            <li>
              <textarea class="ckeditor" id="manager" name="manager"><{$edit.manager}></textarea>
              <{if $error.manager ne ''}><div class="error"><{$error.manager}></div><{/if}>
            </li>
            <li>
