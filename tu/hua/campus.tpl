...
<div id="main_body">
<form id="myform" name="myform" action="campus.php" method="POST">
<input type="hidden" id="mode" name="mode" value="">
<input type="hidden" id="add_flg" name="add_flg" value="<{$edit.add_flg}>">
    <div id="conts">
      <h2><{$table.campus.text}></h2>
      <div class="conts_content">
        ...
        <ul>
            ...
            <{/if}>
            <li>
              <textarea class="ckeditor" id="campus" name="campus"><{$edit.campus}></textarea>
              <{if $error.campus ne ''}><div class="error"><{$error.campus}></div><{/if}>
            </li>
            <li>
