...
<div id="main_body">
<form id="myform" name="myform" action="ceospeech.php" method="POST">
<input type="hidden" id="mode" name="mode" value="">
<input type="hidden" id="add_flg" name="add_flg" value="<{$edit.add_flg}>">
    <div id="conts">
      <h2><{$table.ceospeech.text}></h2>
      <div class="conts_content">
        ...
        <ul>
            ...
            <{/if}>
            <li>
              <textarea class="ckeditor" id="ceospeech" name="ceospeech"><{$edit.ceospeech}></textarea>
              <{if $error.ceospeech ne ''}><div class="error"><{$error.ceospeech}></div><{/if}>
            </li>
            <li>
