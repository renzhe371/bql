...
<div id="main_body">
<form id="myform" name="myform" action="develop.php" method="POST">
<input type="hidden" id="mode" name="mode" value="">
<input type="hidden" id="add_flg" name="add_flg" value="<{$edit.add_flg}>">
    <div id="conts">
      <h2><{$table.develop.text}></h2>
      <div class="conts_content">
        ...
        <ul>
            ...
            <{/if}>
            <li>
              <textarea class="ckeditor" id="develop" name="develop"><{$edit.develop}></textarea>
              <{if $error.develop ne ''}><div class="error"><{$error.develop}></div><{/if}>
            </li>
            <li>
