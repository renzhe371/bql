...
<div id="main_body">
<form id="myform" name="myform" action="stock.php" method="POST">
<input type="hidden" id="mode" name="mode" value="">
<input type="hidden" id="add_flg" name="add_flg" value="<{$edit.add_flg}>">
    <div id="conts">
      <h2><{$table.stock.text}></h2>
      <div class="conts_content">
        ...
        <ul>
            ...
            <{/if}>
            <li>
              <textarea class="ckeditor" id="stock" name="stock"><{$edit.stock}></textarea>
              <{if $error.stock ne ''}><div class="error"><{$error.stock}></div><{/if}>
            </li>
            <li>
