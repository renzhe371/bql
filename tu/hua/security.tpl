...
<div id="main_body">
<form id="myform" name="myform" action="security.php" method="POST">
<input type="hidden" id="mode" name="mode" value="">
<input type="hidden" id="add_flg" name="add_flg" value="<{$edit.add_flg}>">
    <div id="conts">
      <h2><{$table.security.text}></h2>
      <div class="conts_content">
        ...
        <ul>
            ...
            <{/if}>
            <li>
              <textarea class="ckeditor" id="security" name="security"><{$edit.security}></textarea>
              <{if $error.security ne ''}><div class="error"><{$error.security}></div><{/if}>
            </li>
            <li>
