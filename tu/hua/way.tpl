...
<div id="main_body">
<form id="myform" name="myform" action="way.php" method="POST">
<input type="hidden" id="mode" name="mode" value="">
<input type="hidden" id="add_flg" name="add_flg" value="<{$edit.add_flg}>">
    <div id="conts">
      <h2><{$table.way.text}></h2>
      <div class="conts_content">
        ...
        <ul>
            ...
            <{/if}>
            <li>
              <textarea class="ckeditor" id="way" name="way"><{$edit.way}></textarea>
              <{if $error.way ne ''}><div class="error"><{$error.way}></div><{/if}>
            </li>
            <li>
