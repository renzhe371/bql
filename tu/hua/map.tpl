...
<div id="main_body">
<form id="myform" name="myform" action="map.php" method="POST">
<input type="hidden" id="mode" name="mode" value="">
<input type="hidden" id="add_flg" name="add_flg" value="<{$edit.add_flg}>">
    <div id="conts">
      <h2><{$table.map.text}></h2>
      <div class="conts_content">
        ...
        <ul>
            ...
            <{/if}>
            <li>
              <textarea class="ckeditor" id="map" name="map"><{$edit.map}></textarea>
              <{if $error.map ne ''}><div class="error"><{$error.map}></div><{/if}>
            </li>
            <li>
