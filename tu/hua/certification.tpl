...
<div id="main_body">
<form id="myform" name="myform" action="certification.php" method="POST">
<input type="hidden" id="mode" name="mode" value="">
<input type="hidden" id="add_flg" name="add_flg" value="<{$edit.add_flg}>">
    <div id="conts">
      <h2><{$table.certification.text}></h2>
      <div class="conts_content">
        ...
        <ul>
            ...
            <{/if}>
            <li>
              <textarea class="ckeditor" id="certification" name="certification"><{$edit.certification}></textarea>
              <{if $error.certification ne ''}><div class="error"><{$error.certification}></div><{/if}>
            </li>
            <li>
