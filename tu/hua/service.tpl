...
<div id="main_body">
<form id="myform" name="myform" action="services.php" method="POST">
<input type="hidden" id="mode" name="mode" value="">
<input type="hidden" id="add_flg" name="add_flg" value="<{$edit.add_flg}>">
    <div id="conts">
      <h2><{$table.service.text}></h2>
      <div class="conts_content">
        ...
        <ul>
            ...
            <{/if}>
            <li>
              <textarea class="ckeditor" id="service" name="service"><{$edit.service}></textarea>
              <{if $error.service ne ''}><div class="error"><{$error.service}></div><{/if}>
            </li>
            <li>
