...
<div id="main_body">
<form id="myform" name="myform" action="network.php" method="POST">
<input type="hidden" id="mode" name="mode" value="">
<input type="hidden" id="add_flg" name="add_flg" value="<{$edit.add_flg}>">
    <div id="conts">
      <h2><{$table.network.text}></h2>
      <div class="conts_content">
        ...
        <ul>
            ...
            <{/if}>
            <li>
              <textarea class="ckeditor" id="network" name="network"><{$edit.network}></textarea>
              <{if $error.network ne ''}><div class="error"><{$error.network}></div><{/if}>
            </li>
            <li>
