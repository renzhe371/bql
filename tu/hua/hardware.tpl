...
<div id="main_body">
<form id="myform" name="myform" action="hardware.php" method="POST">
<input type="hidden" id="mode" name="mode" value="">
<input type="hidden" id="add_flg" name="add_flg" value="<{$edit.add_flg}>">
    <div id="conts">
      <h2><{$table.hardware.text}></h2>
      <div class="conts_content">
        ...
        <ul>
            ...
            <{/if}>
            <li>
              <textarea class="ckeditor" id="hardware" name="hardware"><{$edit.hardware}></textarea>
              <{if $error.hardware ne ''}><div class="error"><{$error.hardware}></div><{/if}>
            </li>
            <li>
