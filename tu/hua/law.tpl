...
<div id="main_body">
<form id="myform" name="myform" action="law.php" method="POST">
<input type="hidden" id="mode" name="mode" value="">
<input type="hidden" id="add_flg" name="add_flg" value="<{$edit.add_flg}>">
    <div id="conts">
      <h2><{$table.law.text}></h2>
      <div class="conts_content">
        ...
        <ul>
            ...
            <{/if}>
            <li>
              <textarea class="ckeditor" id="law" name="law"><{$edit.law}></textarea>
              <{if $error.law ne ''}><div class="error"><{$error.law}></div><{/if}>
            </li>
            <li>
