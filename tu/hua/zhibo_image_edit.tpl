...
<div id="main_body">
<form id="myform" name="myform" action="market_zhibo_image.php" method="post" enctype="multipart/form-data">
...
<input type="hidden" id="image_id" name="image_id" value="<{$edit.image_id}>">
    <div id="conts">
      <h2>直播图片<{if $edit.add_flg eq '1'}>添加<{else}>编辑<{/if}></h2>
      <div class="conts_content">
      	<div id="add">
        <ul>
            <li>
              <label><{$table.image_id.text}><{if $table.image_id.isNull ne ''}>&nbsp;<font color="#FF0000">*</font><{/if}></label>
              <input class="medium-input" type="text" id="image_id" name="image_id" maxlength="<{$table.image_id.maxlength}>" value="<{$edit.image_id}>" >
              <{if $error.image_id ne ''}><span class="error"><{$error.image_id}></span><{/if}>
            </li>
            <li>
            ...
            <li>
              <label><{$table.image_path2.text}></label>
              <table style="border:0;">
              	<tr>
