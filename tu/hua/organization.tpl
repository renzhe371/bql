...
<div id="main_body">
<form id="myform" name="myform" action="organization.php" method="POST">
<input type="hidden" id="mode" name="mode" value="">
<input type="hidden" id="add_flg" name="add_flg" value="<{$edit.add_flg}>">
    <div id="conts">
      <h2><{$table.organization.text}></h2>
      <div class="conts_content">
        ...
        <ul>
            ...
            <{/if}>
            <li>
              <textarea class="ckeditor" id="organization" name="organization"><{$edit.organization}></textarea>
              <{if $error.organization ne ''}><div class="error"><{$error.organization}></div><{/if}>
            </li>
            <li>
