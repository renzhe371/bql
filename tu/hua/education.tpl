...
<div id="main_body">
<form id="myform" name="myform" action="education.php" method="POST">
<input type="hidden" id="mode" name="mode" value="">
<input type="hidden" id="add_flg" name="add_flg" value="<{$edit.add_flg}>">
    <div id="conts">
      <h2><{$table.education.text}></h2>
      <div class="conts_content">
        ...
        <ul>
            ...
            <{/if}>
            <li>
              <textarea class="ckeditor" id="education" name="education"><{$edit.education}></textarea>
              <{if $error.education ne ''}><div class="error"><{$error.education}></div><{/if}>
            </li>
            <li>
