...
<div id="main_body">
<form id="myform" name="myform" action="about.php" method="POST">
<input type="hidden" id="mode" name="mode" value="">
<input type="hidden" id="add_flg" name="add_flg" value="<{$edit.add_flg}>">
    <div id="conts">
      <h2><{$table.about.text}></h2>
      <div class="conts_content">
        ...
        <ul>
            ...
            <{/if}>
            <li>
              <textarea class="ckeditor" id="about" name="about"><{$edit.about}></textarea>
              <{if $error.about ne ''}><div class="error"><{$error.about}></div><{/if}>
            </li>
            <li>
