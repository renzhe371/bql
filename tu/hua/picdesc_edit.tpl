...
<div id="main_body">
<form id="myform" name="myform" action="picdesc.php" method="post" enctype="multipart/form-data">
<input type="hidden" id="mode" name="mode" value="">
<input type="hidden" id="add_flg" name="add_flg" value="<{$edit.add_flg}>">
<input type="hidden" id="desc_id" name="desc_id" value="<{$edit.desc_id}>">
    <div id="conts">
      ...
      <div class="conts_content">
        ...
        <ul>
            <li>
                <label><{$table.desc_name.text}><{if $table.desc_name.isNull ne ''}>&nbsp;<font color="#FF0000">*</font><{/if}></label>
                <input class="medium-input" type="text" id="desc_name" name="desc_name" maxlength="<{$table.desc_name.maxlength}>" value="<{$edit.desc_name}>" >
                <{if $error.desc_name ne ''}><span class="error"><{$error.desc_name}></span><{/if}>
            </li>
            <li>
              ...
              <select name="category_id" id="category_id" style="width:auto;">
				...
				<{html_options options=""|getDescCategory selected=$edit.category_id }>				
			  </select>
