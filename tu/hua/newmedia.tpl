...
<div id="main_body">
<form id="myform" name="myform" action="newmedia.php" method="POST">
<input type="hidden" id="mode" name="mode" value="">
<input type="hidden" id="add_flg" name="add_flg" value="<{$edit.add_flg}>">
    <div id="conts">
      <h2><{$table.newmedia.text}></h2>
      <div class="conts_content">
        ...
        <ul>
            ...
            <{/if}>
            <li>
              <textarea class="ckeditor" id="newmedia" name="newmedia"><{$edit.newmedia}></textarea>
              <{if $error.newmedia ne ''}><div class="error"><{$error.newmedia}></div><{/if}>
            </li>
            <li>
