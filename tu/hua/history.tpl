...
<div id="main_body">
<form id="myform" name="myform" action="history.php" method="POST">
<input type="hidden" id="mode" name="mode" value="">
<input type="hidden" id="add_flg" name="add_flg" value="<{$edit.add_flg}>">
    <div id="conts">
      <h2><{$table.history.text}></h2>
      <div class="conts_content">
        ...
        <ul>
            ...
            <{/if}>
            <li>
              <textarea class="ckeditor" id="history" name="history"><{$edit.history}></textarea>
              <{if $error.history ne ''}><div class="error"><{$error.history}></div><{/if}>
            </li>
            <li>
