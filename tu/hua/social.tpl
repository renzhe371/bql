...
<div id="main_body">
<form id="myform" name="myform" action="social.php" method="POST">
<input type="hidden" id="mode" name="mode" value="">
<input type="hidden" id="add_flg" name="add_flg" value="<{$edit.add_flg}>">
    <div id="conts">
      <h2><{$table.social.text}></h2>
      <div class="conts_content">
        ...
        <ul>
            ...
            <{/if}>
            <li>
              <textarea class="ckeditor" id="social" name="social"><{$edit.social}></textarea>
              <{if $error.social ne ''}><div class="error"><{$error.social}></div><{/if}>
            </li>
            <li>
