<div id="main_body">
<form id="myform" name="myform" action="exper_category.php" method="POST">
      ...
      <{if $list|smarty:nodefaults|@count ne '0'}>
        <table cellpadding="0" cellspacing="0">
          <tr>
			...
			<th width="30%"><a href="javascript:setOrderBy('image_path <{if $activeField eq 'image_path'}><{$ascdesc}><{else}><{$sortAD}><{/if}>');"><{$table.image_path.text}></a><{if $ordField eq "image_path desc"}>↑<{/if}><{if $ordField eq "image_path asc"}>↓<{/if}></th>
