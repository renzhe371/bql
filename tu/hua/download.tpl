...
<div id="main_body">
<form id="myform" name="myform" action="download.php" method="POST">
<input type="hidden" id="mode" name="mode" value="">
<input type="hidden" id="add_flg" name="add_flg" value="<{$edit.add_flg}>">
    <div id="conts">
      <h2><{$table.download.text}></h2>
      <div class="conts_content">
        ...
        <ul>
            ...
            <{/if}>
            <li>
              <textarea class="ckeditor" id="download" name="download"><{$edit.download}></textarea>
              <{if $error.download ne ''}><div class="error"><{$error.download}></div><{/if}>
            </li>
            <li>
