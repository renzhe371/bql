<div id="main_body">
<form id="myform" name="myform" action="exper_category.php" method="post" enctype="multipart/form-data">
    ...
    <div id="conts">
      ...
      <div class="conts_content">
        ...
        <ul>
			...
			<li>
              <label><{$table.image_path.text}><font color="#FF0000">*(最佳像素比例:112*33)</font></label>
