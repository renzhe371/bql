...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'index.tpl', 16, false),array('modifier', 'truncate', 'index.tpl', 22, false),array('modifier', 'date_format', 'index.tpl', 37, false),)), $this); ?>
<!-- main -->
		...
		<div class="float-l bql_main_new">
			<div class="bql_main_new_box">
				...
				<div class="bql_main_new_thumbnail cf">
					<a class="float-l" href="/NewsContent<?php echo ((is_array($_tmp=$this->_tpl_vars['news_list'][0]['news_id'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
.html">
						<img width="140" height="100" src="http://www.protruly.com.cn/<?php echo ((is_array($_tmp=$this->_tpl_vars['news_list'][0]['image_path'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
" alt="">
					</a>
					<div>
						<h3 class="overflow-nowrap">
							<a href="/NewsContent<?php echo ((is_array($_tmp=$this->_tpl_vars['news_list'][0]['news_id'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
.html">						
								<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['news_list'][0]['news_title'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')))) ? $this->_run_mod_handler('truncate', true, $_tmp, 42) : smarty_modifier_truncate($_tmp, 42)); ?>
						...
						<p class="overflow">
							<a href="/NewsContent<?php echo ((is_array($_tmp=$this->_tpl_vars['news_list'][0]['news_id'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
.html">			
								<?php echo $this->_tpl_vars['news_list'][0]['news_ms']; ?>
...
$this->_sections['loop']['loop'] = is_array($_loop=$this->_tpl_vars['news_list']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
				<p class="po-r">
					<a class="display-b overflow-nowrap" href="/NewsContent<?php echo ((is_array($_tmp=$this->_tpl_vars['news_list'][$this->_sections['loop']['index']]['news_id'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
.html">
						<?php echo ((is_array($_tmp=$this->_tpl_vars['news_list'][$this->_sections['loop']['index']]['news_title'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>

					</a>
					<span class="po-a"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['news_list'][$this->_sections['loop']['index']]['create_time'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')))) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d') : smarty_modifier_date_format($_tmp, '%Y-%m-%d')); ?>
</span>
				</p>
				<?php endfor; endif; ?>
			</div>
