			...
			<div class="touzizhe_list_box">
				...
				<input type="hidden" name="p" value="">
					...
					<dl class="cf float-l">
						...
						<dd>
							<h3 class="overflow-nowrap"><{$list[loop].report_title}></h3>
							<p class="overflow-nowrap"><{$list[loop].report_title}></p>
							<a class="display-b" href="<{$list[loop].report_pdf}>" target="_blank">点击查看</a>
						</dd>
					</dl>
					<{/section}>
