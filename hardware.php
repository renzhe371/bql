...
class thisPage extends MyWeb {
	...
	function IMDEX($form){
		...
		$sql="select hardware from ".$this->table_name;
		$hardware_content=$dbclass->GetOne($sql);
		$smarty->assign("hardware_content",$hardware_content);
		...
		$this->template_name="hardware.tpl";
