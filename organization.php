...
class thisPage extends MyWeb {
	...
	function IMDEX($form){
		...
		$sql="select organization from ".$this->table_name;
		$organization_content=$dbclass->GetOne($sql);
		$smarty->assign("organization_content",$organization_content);
		...
		$this->template_name="organization.tpl";
