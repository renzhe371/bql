...
class thisPage extends MyWeb {
	...
	function thisPage(&$server,&$request) {
		global $db_corp_category;
		parent::__construct($server,$request);
		
		$this->table=$db_corp_category;
		$this->table_name=_TABLE."corp_category";
	...
	function SEARCH_PAGE($form){
		...
		$this->template_name="corp_category_list.tpl";
	}
	...
	function formPage($form)
	{
		...
		$this->template_name="corp_category_edit.tpl";
	}
	...
	function SAVE($form) {
		...
		$this->location ( "corp_category.php?mode=PAGELIST" );
	}
