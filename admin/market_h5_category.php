...
class thisPage extends MyWeb {
	...
	function thisPage(&$server,&$request) {
		global $db_h5_category;
		parent::__construct($server,$request);
		
		$this->table=$db_h5_category;
		$this->table_name=_TABLE."h5_category";
	...
	function SEARCH_PAGE($form){
		...
		$this->template_name="h5_category_list.tpl";
	}
	...
	function formPage($form)
	{
		...
		$this->template_name="h5_category_edit.tpl";
	}
	...
	function SAVE($form) {
		...
		else 
		{
			...
			$this->location ( "market_h5_category.php" );
		}	
	}
