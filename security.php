...
class thisPage extends MyWeb {
	...
	function IMDEX($form){
		...
		$sql="select security from ".$this->table_name;
		$security_content=$dbclass->GetOne($sql);
		$smarty->assign("security_content",$security_content);
		...
		$this->template_name="security.tpl";
