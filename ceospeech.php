...
class thisPage extends MyWeb {
	...
	function IMDEX($form){
		...
		$sql="select ceospeech from ".$this->table_name;
		$ceospeech_content=$dbclass->GetOne($sql);
		$smarty->assign("ceospeech_content",$ceospeech_content);
		...
		$this->template_name="ceospeech.tpl";
