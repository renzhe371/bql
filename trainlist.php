...
class thisPage extends MyWeb {
	...
	function IMDEX($form){
		...
		$t_sql="select * from ".$this->table_name;
		$t_sql.=" ORDER BY order_num desc";
		$t_res = $dbclass->GetAll($t_sql);
		$smarty->assign("list",$t_res);
		...
		$this->template_name="trainlist.tpl";
	}
}
